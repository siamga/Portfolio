...
***
<h2> #1. Project - 경제 충격을 고려한 머신 러닝 기반 기업 회생 예측 및 정책 제언 </h2> 
...
|--|--|--|
|성장성지표(3)<br/>수익성지표(5)<br/>활동성지표(4)<br/>안정성지표(8)<br/>  | 레버리지 비율(3)<br/>유동성비율(2)<br> |매출액<br/>업종<br/>자산<br/>|
...
| 전통모델 |머신러닝  | 앙상블 |딥러닝|
|--|--|--|--|
|로지스틱 분류  |의사결정나무<br/> KNN<br/> ANN<br/>  |랜덤포레스트<br/>XGBoost<br/>  |딥러닝  |<br/>
<br/>
<h4>2) 모델링 결과 도출<br/>
